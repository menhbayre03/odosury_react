...
export const fetchBundles = {
	REQUEST: "fetchBundles_REQUEST",
	RESPONSE: "fetchBundles_RESPONSE"
};
export const fetchBundleSingle = {
	REQUEST: "fetchBundleSingle_REQUEST",
	RESPONSE: "fetchBundleSingle_RESPONSE"
};
export const fetchBundleLessons = {
	REQUEST: "fetchBundleLessons_REQUEST",
