                        ...
                        >
                            <div className="head-inner">
                                {isMobile ? (
                                    lesson.video ? (
                                        <div
                                            className="vid-rom mobi"
                                            onClick={() => this.openModalVid()}
                                        >
                                            <img
                                                src={
                                                            ...
                                                            <div className="inner">
                                                                {lesson.free ? (
                                                                    <React.Fragment>
                                                                        ...
                                                                        >
                                                                            Манай сайт-д бүртгэлтэй
                                                                            хэрэглэгчид үнэгүй үзэх
                                                                            боломжтой
                                                                        </p>
                                                                    </React.Fragment>
                                                                ) : lesson.sale > 0 &&
                                                                  !lesson.eish ? (
                                                                    ...
                                                                    <React.Fragment>
                                                                        ...
                                                                        >
                                                                            2021 оны шинэ хөтөлбөр
                                                                            дагуу Амжилт кибер
                                                                            сургуулийн мэргэжлийн
                                                                            багш нараар бэлтгэгдсэн
                                                                            ЭЕШ-ийн хичээлүүд{" "}
                                                        ...
                                                        <div className="teacher-side">
                                                            ...
                                                            <div>
                                                                <h5>
                                                                    Багш:{" "}
                                                                    <span>
                                                                        {lesson.teacher.last_name.charAt(
                                                                            0
                                                                        ) +
                                                                            ". " +
                                                                            lesson.teacher
                                                    ...
                                                    <div className="inner">
                                                        {lesson.free ? (
                                                            ...
                                                            <React.Fragment>
                                                                ...
                                                                >
                                                                    2021 оны шинэ хөтөлбөр дагуу
                                                                    Амжилт кибер сургуулийн
                                                                    мэргэжлийн багш нараар
                                                                    бэлтгэгдсэн ЭЕШ-ийн хичээлүүд{" "}
                                                                    <strong>49'000₮</strong>
                                                                </p>
                                                            </React.Fragment>
                                                        ) : (
                                                        ...
                                                        {lesson.eish || lesson.free ? null : (
                                                              (user || {}).wish || []
                                                          ).some((aa) => aa == lesson._id) ? (
                                                            <Button
                                                                onClick={() =>
                                                                    this.addWish(lesson._id, false)
                                                                }
                                                                variant="secondary"
                                                            >
                                                            ...
                                                            <React.Fragment>
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        нэмж төлөөд манай
                                                                        аппликейшнд байгаа бүх
                                                                        хичээлийг үзэх боломжтой
                                                                    </p>
                ...
                {lesson.video && (
                    ...
                    >
                        <Modal.Body>
                            ...
                            <AmjiltVideo src={mediaUrl} isAws={mediaAws} isIntro={true} />
                        </Modal.Body>
                        <Modal.Footer>
                            <div className={"p-m-buttons"}>
                                <div
                                    className={"p-m-btn transparent"}
                                    onClick={() => this.closeModalVid()}
                                >
                                    <span>Хаах</span>
                                </div>
                            </div>
