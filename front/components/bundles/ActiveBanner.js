	...
	return (
		<div className="active-poster-container">
			<img
				src={
					leBundle.thumbnail
						? `http://cdn.odosury.mn${leBundle.thumbnail.path}`
						: `images/${leBundle}`
				}
				alt="active poster"
			...
			<div className="activeBanner-body">
				...
				<div className="title">
					{leBundle && leBundle.title ? leBundle.title : null}
				</div>
				<div className="description">
					{leBundle && leBundle.description
						? leBundle.description
						: null}
				</div>
