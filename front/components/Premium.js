...
class Premium extends Component {
    ...
    render() {
        const {
            main: { premiumPrice, premium, user },
        } = this.props;
        return (
            <React.Fragment>
                                    ...
                                    <div className="benefits">
                                        <div className="benefit">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    Ирээдүйд тасралтгүй нэмэгдэх хичээлүүд болон
                                                    номууд
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <Container>
                                    <Row>
                                        <Col md={4}>
                                            ...
                                            <p>
                                                ODOSURY платформд байршсан 10 чиглэлийн мэргэжлийн,
                                                ур чадварын бүхий л хичээлийн контентууд болон
                                                сонсдог ном, ЭЕШ хичээлүүдийг 1 төлөлтөөр
                                                интернеттэй орчноос гар утас болон компьютер болон
                                                бусад төхөөрөмжөөс хязгааргүй үзэх боломжтой.
                                        ...
                                        <Col md={4}>
                                            ...
                                            />
                                            <p>
                                                Мөн зөвхөн PREMIUM хэрэглэгчиддээ зориулж цогц
                                                систем агуулгын дагуу бэлтгэсэн хичээлүүдийг бүрэн
                                                судалж дууссаны дараа шалгалт өгч сертификат авах
                                                боломжийг олгодог.
                                            </p>
                                        </Col>
                                        <Col md={4}>
                                            ...
                                            <p>
                                                Харилцагчтайгаа байнга эргэх холбоотой байдаг учраас
                                                та цаашид ямар төрлийн сургалт авах сонирхолтой
                                                байгаагаа илэрхийлэхэд бид таны хүсэлтийг хүлээн авч
                                                тухайг чиглэлийн хичээлийг оруулдгаараа онцлогтой.
                                            </p>
                                        </Col>
                                    </Row>
                                </Container>
                        ...
                        <Container>
                            <div className="prem-cont">
                                <div className="bolomjq">
                                    ...
                                    <ul>
                                        <li>
                                            <span className="fir">1</span>
                                            <span>Хязгааргүй хэрэглээ</span>
                                        </li>
                                        {/* <li><span className="fir">1</span><span>1 жилийн хязгааргүй хэрэглээ</span></li> */}
                                        <li>
                                            <span className="fir">2</span>
                                            <span>
                                                Олон төрлийн мэргэжлийн болоод ур чадварын
                                                хэрэгцээтэй сургалтуудыг нэг дор авах
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">3</span>
                                            <span>
                                                Платформ дээр байрлах бүх багцыг үнэгүй үзэх
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">4</span>
                                            <span>
                                                Зөвхөн 1 сургалтанд 1 удаа сурах төлбөрөөр бүх
                                                төрлийн хичээлийг үзэх эрх
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">5</span>
                                            <span>Бүх насныханд зориулсан</span>
                                        </li>
                                        <li>
                                            <span className="fir">6</span>
                                            <span>
                                                Салбар бүрийн чадварлаг багш нараар бэлдүүлсэн
                                                хичээлийг үзэх эрх
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">7</span>
                                            <span>
                                                Хичээл болгоныг систэмтэйгээр, ойлгомжтойгоор
                                                сурахаар бэлтгэсэн учраас ойлгоход хялбар
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">8</span>
                                            <span>
                                                Чанар болон дуу дүрсний шаардлага хангасан сургалтын
                                                контентуудыг үзнэ
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">9</span>
                                            <span>
                                                Хичээлийг компьютер, гар утас, таблет, телевизор
                                                зэргээс үзэх боломжтой
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">10</span>
                                            <span>
                                                Интернеттэй л бол хаанаас ч 7/24 цаг сурах боломж
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">11</span>
                                            <span>
                                                Хичээлтэй холбоотой шалгалт өгч сертификат авах эрх
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">12</span>
                                            <span>
                                                Дэлхийн шилдэг бэстселлэр номнуудыг хураангуй
                                                хэлбэрээр сонсох боломж
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">13</span>
                                            <span>
                                                Хичээлийг систэмтэйгээр үзэж судалснаар сонирхогчоос
                                                мэргэжлийн түвшинд хүрэх боломж
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">14</span>
                                            <span>
                                                Зөвхөн ODOSURY хэрэглэгчдэд тусгайлан зориулж
                                                бэлтгэсэн оюуны өмчийн контентууд
                                            </span>
                                        </li>
                                        <li>
                                            <span className="fir">15</span>
                                            <span>
                                                Үзсэн хичээлээр мэргэшиж, хаана ч ажиллахад
                                                гологдохгүй чадвартай болох
                                            </span>
                                        </li>
                                    </ul>
                                </div>
