...
class Home extends Component {
    ...
    async responseFacebook(data) {
        ...
        if (response.success === true) {
            ...
            this.setState({ fbLoading: false, showLogin: false, data: null }, () =>
                dispatch(actions.setUser(response, sss))
            );
        } else {
    ...
    async handleSubmit(e) {
        ...
        if (Object.keys(errors).length === 0 && errors.constructor === Object) {
            ...
            if (response.success === true) {
                ...
                this.setState({ loading: false, showLogin: false, data: null }, () =>
                    dispatch(actions.setUser(response, sss))
                );
            } else {
    ...
    async reSend() {
        ...
        const response = await Api.login(`/api/resend/email`, {
            email: this.state.pendingEmail ? this.state.pendingEmail : this.state.emailRegister,
    ...
    async handleSubmitRegister(e) {
        ...
        if (this.state.usernameRegister == null || this.state.usernameRegister === "") {
            ...
            errors.usernameErrorText =
                "Хэрэглэгчийн нэр бичиглэл буруу байна! Жижиг a-z, тоо болон _ оруулж болно.";
        } else {
            noErr.usernameRegister = false;
            noErr.usernameErrorText = null;
        }
        if (
            this.state.phoneRegister.toString() != null &&
            this.state.phoneRegister.toString() !== "" &&
            !isNaN(this.state.phoneRegister)
        ) {
                                        ...
                                        <div className="login-left">
                                            ...
                                            <Form onSubmit={this.handleSubmitRegister.bind(this)}>
                                                ...
                                                <Form.Group>
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        isInvalid={
                                                            !!this.state.error.usernameRegister
                                                        }
                                                    />
                                                    <Form.Control.Feedback type="invalid">
                                                        {this.state.error.usernameErrorText
                                                            ? this.state.error.usernameErrorText
                                                ...
                                                <Form.Group>
                                                    ...
                                                    <Form.Control
                                                        ...
                                                        isInvalid={
                                                            !!this.state.error.passwordRegister
                                                        }
                                                        onChange={(e) =>
                                                            this.setState({
                                                    ...
                                                    {/* <ReactPasswordStrength
                                                        ...
                                                        /> */}
                                                    <Form.Control.Feedback type="invalid">
                                                        {this.state.error.passwordNoValid
                                                ...
                                                <Form.Group>
                                                    ...
                                                    />
                                                    <Form.Control.Feedback type="invalid">
                                                        {this.state.error.passwordNoMatch
                                                            ? "Нууц үг зөрж байна"
                                                ...
                                                <Form.Group className="reg-check">
                                                    <Form.Check
                                                        ...
                                                        type="checkbox"
                                                        label="Үйлчигээний нөхцөлийг зөвшөөрч байна"
                                                        isInvalid={!!this.state.error.terms}
                                                        id="reg-check"
                                                        htmlFor="reg-check"
                                                    />
                                                </Form.Group>
                                                <div className="text-center">
                                                    ...
                                                    >
                                                        Та бүртгүүлэх товчийг дарсанаар манай{" "}
                                                        <span
                                                            style={{
                                                                color: "#1a1aa2",
                                                                cursor: "pointer",
                                                    ...
                                                    <Button
                                                        style={{
                                                            position: "relative",
                                                            paddingLeft: this.state.registerLoading
                                                                ? 35
                                                                : 20,
                                                        }}
                                            ...
                                            <div className="login-bottom-button">
                                                ...
                                                <Button
                                                    style={{
                                                        position: "relative",
                                                        paddingLeft: this.state.loading ? 35 : 20,
                                                    }}
                                                    onClick={() =>
                                            ...
                                            <div className="login-left">
                                                ...
                                                <div className="login-bottom-button">
                                                    ...
                                                    <Button
                                                        style={{
                                                            position: "relative",
                                                            paddingLeft: this.state.loading
                                                                ? 35
                                                                : 20,
                                                        }}
                                                        onClick={() =>
                                ...
                                <Col md={6}>
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Таны сурч хөгжих хязгааргүй хэрэгцээг хангахын тулд
                                                бүгдийг нэг дор цогцлоосон онлайн сургалтын
                                                платформд тавтай морил.
                                            </p>
                                        </div>
                                    </div>
                                </Col>
