    ...
    render() {
        ...
        const columns = [
            {
                key: "_id",
                title: "№",
                render: (text, record, idx) => (pageNum - 1) * 50 + (idx + 1),
            },
            {
                key: "user",
                ...
                render: (text, record) => (
                    <React.Fragment>
                        <Button
                            ...
                            onClick={() => dispatch(setPaymentStatus(record._id, "delete"))}
                            danger
                            size={"small"}
                        />
                    </React.Fragment>
        ...
        return (
            <Card
                ...
                bordered={true}
                extra={[<Button onClick={() => this.openModal()}>ҮҮСГЭХ</Button>]}
            >
                <Form onFinish={this.searchUser.bind(this)}>
                    ...
                    <div>
                        ...
                        <Select
                            ...
                            onChange={(e) => this.setState({ custom: e })}
                        >
                                    ...
                                    {record.custom ? (
                                        <Col span={24}>
                                            <Card title={"Тайлбар: "} size={"small"}>
                                                <List.Item>
                                                    <Text ellipsis>{record.description}</Text>
                                                </List.Item>
                                            </Card>
                                        </Col>
                                    ) : record.test ? (
                                        <Col span={24}>
                                            <Card title={"Тест: "} size={"small"}>
                                                <List.Item
                                                    actions={[
                                                        <NumberFormat
                                                            value={record.amount || 0}
                ...
                >
                    <div>
                        <Form.Item label="Хэрэглэгч" labelCol={{ span: 5 }}>
                            <Select
                                size="middle"
                                showSearch
                                style={{ width: "100%" }}
                                ...
                                notFoundContent={
                                    searchLoader ? <Spin size="middle" /> : "Хэрэглэгч олдсонгүй"
                                }
                            >
                        ...
                        <Form.Item label="Төрөл" labelCol={{ span: 5 }}>
                            <Select
                                value={item.type}
                        ...
                        <Form.Item label="Тайлбар" labelCol={{ span: 5 }}>
                            <Input.TextArea
                                rows={4}
                        ...
                        >
                            <Button
                                ...
                                disabled={submitTransLoader}
                            >
                                Болих
                            </Button>
                            <Button
                                onClick={() => this.onSave()}
                                loading={submitTransLoader}
                                type="primary"
                            >
                                Хадгалах
                            </Button>
