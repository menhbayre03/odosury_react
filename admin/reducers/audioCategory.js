import {
    openAudioCategoryModal,
    closeAudioCategoryModal,
    audioCategoryChangeHandler,
    submitAudioCategory,
    deleteAudioCategory,
    getAudioCategory
} from "../actionTypes";
...
export default(state = initialState, action) => {
    switch (action.type) {
        case deleteAudioCategory.REQUEST:
            if(action.json._id){
                return {
                    ...state,
        ...
        case deleteAudioCategory.RESPONSE:
        ...
        case getAudioCategory.REQUEST:
            return {
                ...state,
                status: 1
            };
        case getAudioCategory.RESPONSE:
            return {
                ...state,
                status: 0,
                categories: (action.json.categories || []),
        ...
        case audioCategoryChangeHandler.REQUEST:
            return {
                ...state,
                category:{
                    ...state.category,
        ...
        case openAudioCategoryModal.REQUEST:
            return {
                ...state,
                openModal: true,
                category:action.json,
            };
        case closeAudioCategoryModal.REQUEST:
            return {
                ...state,
                openModal: false,
                category:{},
            };
        case submitAudioCategory.REQUEST:
            return {
                ...state,
                submitCategoryLoader: true,
            };
        case submitAudioCategory.RESPONSE:
            if(action.json.success){
                if(action.json._id){
                    return {
                        ...state,
